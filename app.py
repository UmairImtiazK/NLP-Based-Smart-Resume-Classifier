...
st.set_page_config(
    page_title="Smart Resume Classifier - Smart Resume Classifier",
    page_icon="📄",
    layout="wide",
...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown("---")
        st.markdown("### 📧 Contact")
        st.markdown("**Developer:** Hassan & Umair")
        st.markdown("**Email:** umairimtiaz664@gmail.com")
        st.markdown("**GitHub:** umairImtiazK")
...
def show_about_page():
    ...
    with col4:
        st.markdown("""
        <div style="text-align: center;">
            <a href="mailto:umairimtiaz664@gmail.com" style="text-decoration: none;">
                <div style="padding: 1rem; background-color: #F8FAFC; border-radius: 8px; border: 2px solid #E5E7EB;">
                    <h4>📧 Email</h4>
                    <p>Direct contact</p>
                </div>
...
def show_footer():
    ...
    <div style="text-align: center; color: #64748B; padding: 1rem 0;">
        ...
        <p style="margin: 0.5rem 0; font-size: 0.9rem;">Developed with ❤️ by <strong>Umair</strong></p>
